...
// djg  char* stewardesses = "stewardesses";
  char* stewardesses = (char*) "stewardesses";
...
// djg  munit_assert_string_equal(user_data, "µnit");
  munit_assert_string_equal((char*)user_data, "µnit");
...
// djg int main(int argc, char* argv[MUNIT_ARRAY_PARAM(argc + 1)]) {
